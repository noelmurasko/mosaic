...
// rhomb1 substitution
Tile R1=Tile(shift(0,2*e)*rotate(180)*scale(1/tau),rhomb1,lightyellow);
Tile R2=Tile(shift(-d,e)*rotate(216)*scale(1/tau),rhomb1,lightyellow);
Tile R3=Tile(shift(d,e)*rotate(144)*scale(1/tau),rhomb1,lightyellow);
