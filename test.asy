...
substitution sRule1=substitution(S,T);
int n=3;
mosaic M=mosaic(square,n,sRule1);

substitution sRule2=substitution(S,T);
//mosaic M=mosaic(square,n,sRule1);
...
// other notes:
// -  substitution two mosaics is fine
// - two mrules and one mosaic is fine
// - mrules and two mosaics IS NOT fine IF the first mosaic comes before the second rule
// - two mrules and two mosaics IS fine IF both mosaics come after the substitution definitions
